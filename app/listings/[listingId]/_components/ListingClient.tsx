...
import { createReservation } from "@/services/reservation"; // Removed the createPaymentSession import
...
const ListingClient: React.FC<ListingClientProps> = ({
  ...
  // Update: Instead of createPaymentSession, we now call createReservation directly
  const onCreateReservation = () => {
    ...
    startTransition(async () => {
      try {
        ...
        // Directly create the reservation without Stripe
        ...
        router.push("/reservations"); // Redirect to reservations page or wherever you want
      } catch (error: any) {
